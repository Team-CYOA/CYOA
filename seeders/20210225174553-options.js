...
queryInterface.bulkInsert('options', [{
    ...
    nextEncounter: -1,
    consequence: "Terminal Consequence: As fortune would have it, you find a medium sized ball frequently used in team-based competitive sports involving a net and some sand. With a little creativity, and a lot of desperate isolation, you are able to establish communication with the ball, and live happily ever after.",
    encounterID: 3,
    createdAt: new Date(),
    updatedAt: new Date()
    },
    ...
    nextEncounter: -1,
    consequence: "Terminal Consequence: Seriously? Eat the fruit? From the alien tree in an alien forest? Did you not read Into the Wild? Not even see the movie? You die.",
    encounterID: 5,
    createdAt: new Date(),
    updatedAt: new Date()
    },
