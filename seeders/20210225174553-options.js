module.exports = {
  up: async (queryInterface) => {
    queryInterface.bulkInsert('options', [{
      optionText: 'That was a rough landing- I need to check the damage to my ship as quickly as possible. (Climb out the window of you ship)',
      nextEncounter: 2,
    ...
    },
    {
      ...
      nextEncounter: 5,
      consequence: 'Armed with your trusty intuition, you stomp off into the forest… hoping you’ll stumble across your warp belt, somehow.',
      encounterID: 2,
      checkState: '!hasTools',
      createdAt: new Date(),
      updatedAt: new Date(),
    ...
    },
    {
      ...
      nextEncounter: 5,
      consequence: 'Consequence: With a surge of determination (however misplaced it may be), you set off into the woods to find your missing parts.',
      encounterID: 3,
      createdAt: new Date(),
      updatedAt: new Date(),
    },
    {
      optionText: 'You feel the creep of despair as you realize you have neither the know-how to repair your ship nor the liquidity to pay for it. You look around, realizing this forest is your new home. (just give up)',
      nextEncounter: -1,
